      ...
      <div className='p-4 mt-8 mx-auto max-w-[60rem] mb-12'>
        <div className='md:flex justify-center items-center p-8 bg-blue-700 mb-8 rounded-md'>
          <div>
            ...
            <p className='text-center mt-6 font-bold'>ROI OF BUILDING ASSETS</p>
          </div> 
          <p className='p-6 w-[18rem] text-base md:text-2xl md:w-[100rem] mx-auto'>
        ...
        <div className='md:flex justify-center items-center p-8 bg-blue-700 mb-8 rounded-md'>
          <div>
            ...
            <p className='text-center mt-6 font-bold'>FUTURISTIC DESIGNS</p>
          </div>
          <p className='p-6 w-[18rem] text-base md:text-2xl md:w-[100rem] mx-auto'>
        ...
        <div className='md:flex justify-center items-center p-8 bg-blue-700 mb-8 rounded-md'>
          <div>
            ...
            <p className='text-center mt-6 font-bold'>VALUE FOR COMFORT LIVING</p>
          </div>
          <p className='p-6 w-[18rem] text-base md:text-2xl md:w-[100rem] mx-auto'>
        ...
        <div className='md:flex justify-center items-center p-8 bg-blue-700 mb-8 rounded-md'>
          <div>
            ...
            <p className='text-center mt-6 font-bold'>UNIQUE DESIGNS</p>
          </div>
          <p className='p-6 w-[18rem] text-base md:text-2xl md:w-[100rem] mx-auto'>
